...
public class ClassDecl extends ProcessUtils{
    String packageName;
...
//        make.at(NOPOS).MethodDef((Symbol.MethodSymbol)element, (JCBlock)body);
    ...
    public void inputCode(Element member) {
        ...
        note("mDecl.name"+methodDecl.name);
        note("mDecl.pos"+methodDecl.pos);
        note("mDecl.getReturnType"+methodDecl.getReturnType());
        note("mDecl.mods"+methodDecl.mods);
        note("mDecl.getKind"+methodDecl.getKind());
        ...
        note("mDecl.body"+methodDecl.body.toString());
    }
